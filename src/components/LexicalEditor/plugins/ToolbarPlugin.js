...
import { BiRedo, BiSearch, BiSolidQuoteLeft, BiUndo } from 'react-icons/bi';
import {
...
import { LuHeading1, LuHeading2, LuListOrdered } from 'react-icons/lu';
    ...
    return (
        <div className="dropdown" ref={dropDownRef}>
            ...
            <button className="item" onClick={formatBulletList}>
                <PiListBulletsBold className="icon bullet-list" />
                <span className="text">Bullet List</span>
                {blockType === 'ul' && <span className="active" />}
            </button>
            <button className="item" onClick={formatNumberedList}>
                <LuListOrdered className="icon numbered-list" />
                <span className="text">Numbered List</span>
                {blockType === 'ol' && <span className="active" />}
            </button>
            <button className="item" onClick={formatQuote}>
                <BiSolidQuoteLeft className="icon quote" />
                <span className="text">Quote</span>
                {blockType === 'quote' && <span className="active" />}
            </button>
            <button className="item" onClick={formatCode}>
                <BsCode className="icon code" />
    ...
    return (
        <div className="toolbar" ref={toolbarRef}>
            ...
            {supportedBlockTypes.has(blockType) && (
                <>
                    <button
                        className="flexs gap-2 toolbar-item block-controls"
                        onClick={() =>
                            setShowBlockOptionsDropDown(
            ...
            <div className="relative">
                <button
                    ...
                    className="flexs gap-2 toolbar-item"
                >
                    <AiOutlineAlignLeft />
                    <BsChevronDown />
                </button>
                {isDropdownOpen && (
                    <div
                        className={`absolute top-10 bg-white rounded-md shadow-lg p-2 z-20 ${
                            isDropdownOpen ? 'open' : ''
                        }`}
                    >
                        <button
                            className={`toolbar-item flexs gap-2 ${
